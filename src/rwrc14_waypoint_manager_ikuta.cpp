...
/*------for shimizu jikkenn-------*/
//const string file_name("/home/amsl/AMSL_ros_pkg/rwrc14/rwrc14_waypoint_manager/lat_lon_data/dkan_1shu_shimizu1.txt");
const string file_name("/home/amsl/AMSL_ros_pkg/rwrc14/rwrc14_waypoint_manager/lat_lon_data/ikuta-2km_easy.txt");
//const string file_name("/home/amsl/AMSL_ros_pkg/rwrc14/rwrc14_waypoint_manager/lat_lon_data/ikuta3.txt");
	...
	while(ros::ok()){
		...
		if(msg_check_==false){
			...
			if(distance<1000000000 && tf_ok_flag){	
				...
				dist_way.data = whereIsMe(current_tmp, robo, waypoints,wp_count);//ここで現在のwaypointの計算をしている
				id_now = wp_count + 1;
